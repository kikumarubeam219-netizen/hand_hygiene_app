...
## フェー## フェーズ23: Share APIローカルファイル対応
- [x] HTMLをファイルシステムに保存
- [x] ローカルファイルを生成
- [x] Share APIでローカルファイルを共有
- [x] エラーハンドリングの改善

## フェーズ24: ドキュメントディレクトリ取得問題修正
- [x] キャッシュディレクトリの試行
- [x] 一時ディレクトリの試行
- [x] メモリベースのBlobデータURL方式への変更
- [x] エラーハンドリングの強化

## フェーズ25: Base64エンコード問題修正
...
## フェーズ27: PDF直接ダウンロード機能実装
- [x] ブラウザの印刷機能を使用したPDF生成
- [x] Web環境での新しいウィンドウでのPDF表示
- [x] React Native環境でのHTMLクリップボードコピー
- [x] ユーザーへの通知メッセージ更新
